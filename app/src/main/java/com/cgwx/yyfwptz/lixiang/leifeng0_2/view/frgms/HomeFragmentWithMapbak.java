...
public class HomeFragmentWithMapbak extends BaseFragment<HomeFragmentWithMapPresenter, HomeFragmentWithMapbak> implements BaseViewInterface{

    private View view;
    private MapView mapView = null;
    private Button changeView;
    private FragmentManager fragmentManager;
    public HomeFragmentWithMapbak() {}
